...
If you prefer not to use `curl`, copy `vibes-framework.md` from the [`skills/`](https://github.com/a7ul/vibes/tree/main/packages/sdk/skills) directory of this repo to:
...
curl -fsSL https://raw.githubusercontent.com/a7ul/vibes/main/packages/sdk/skills/vibes-framework.md -o .claude/agents/vibes-framework.md
```
