...
description: "Production-grade evals in code - typed datasets, built-in and LLM-as-judge evaluators, experiment runners that live in your repo and run in CI."
---
