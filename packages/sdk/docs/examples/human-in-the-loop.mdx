...
_Source: [`examples/human-in-the-loop.ts`](https://github.com/a7ul/vibes/blob/main/packages/sdk/examples/human-in-the-loop.ts)_

```typescript
import { Agent, ApprovalRequiredError, tool } from "jsr:@vibesjs/sdk";
