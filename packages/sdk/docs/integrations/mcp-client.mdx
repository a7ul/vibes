...
```typescript
import { Agent, MCPStdioClient, MCPToolset } from "npm:@vibesjs/sdk";
...
```typescript
import { Agent, MCPHttpClient, MCPToolset } from "npm:@vibesjs/sdk";
...
```typescript
import { MCPToolset } from "npm:@vibesjs/sdk";
...
```typescript
import { Agent, createManagerFromConfig } from "npm:@vibesjs/sdk";
