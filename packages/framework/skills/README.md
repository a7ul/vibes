# @vibes/framework Agent Skill

An installable agent skill that gives your coding assistant complete knowledge of the `@vibes/framework` API — tools, agents, toolsets, dependency injection, structured output, streaming, testing, graph workflows, MCP, and more.

Once installed, your coding agent can write idiomatic `@vibes/framework` code without needing to look up documentation.
...
Or Claude Code will pick it up automatically when you're working on a project that uses `@vibes/framework`.
