...
import { serializeRunState, deserializeRunState } from "./serialization.ts";

// ---------------------------------------------------------------------------
// Internal helpers
// ---------------------------------------------------------------------------

/** Ensure a value is a plain Error. */
...
export class TemporalAgent<TDeps, TOutput> {
	...
	constructor(agent: Agent<TDeps, TOutput>, options: TemporalAgentOptions<TDeps>) {
		this._agent = agent;
