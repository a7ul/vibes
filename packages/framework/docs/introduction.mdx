...
The framework also ships a full [evaluation framework](/concepts/evals): define typed datasets, score outputs with built-in or LLM-as-judge evaluators, and run experiments with configurable concurrency and retries.
