...
import { ModelRequestsDisabledError } from "../types/errors.ts";

export { createTestModel, TestModel } from "./test_model.ts";
export type {
  DoGenerateResult as TestDoGenerateResult,
  TestModelOptions,
} from "./test_model.ts";
 ...
 * @example
 * ```ts
 * import { setAllowModelRequests } from "./testing/mod.ts";
 *
